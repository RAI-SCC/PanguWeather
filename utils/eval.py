...
def get_loss(model, data_loader, device, loss1, loss2, lat_crop, lon_crop, world_size=4, pressure_weights_epoch=None, surface_weights_epoch=None):
    ...
    static_plevel = np.load('/lsdf/kit/scc/projects/SmartWeater21/constant_masks/pressure_zarr.npy')
    ...
    static_slevel = np.load('/lsdf/kit/scc/projects/SmartWeater21/constant_masks/surface_zarr.npy')
    ...
    climatology_plevel = torch.tensor(np.load('/lsdf/kit/scc/projects/SmartWeater21/constant_masks/pressure_climatology.npy')).to(device)
    climatology_slevel = torch.tensor(np.load('/lsdf/kit/scc/projects/SmartWeater21/constant_masks/surface_climatology.npy')).to(device)
